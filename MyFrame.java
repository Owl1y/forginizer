...
public class MyFrame extends JFrame{
  ...
  public void MyFrame(){
   ...
   JLabel title = new JLabel();                       //this intilizes the text
   ...
   shrinkPhoto.setBackground(new Color(150, 200, 181));//color of the
   shrinkPhoto.setBounds(0, 0, 250, 250);              //puts the panel on the upper left of the GUI with a size of 250x250
   ...
   Frame.setTitle("Verminator");// just the place holder name cause I thought it was funny
